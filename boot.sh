...
# Use custom repo if specified, otherwise default to Velocity
OMARCHY_REPO="${OMARCHY_REPO:-OpenChatGit/velocity}"

echo -e "\nCloning Velocity from: https://github.com/${OMARCHY_REPO}.git"
